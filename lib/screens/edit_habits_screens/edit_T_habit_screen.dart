  ...
  void _saveForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('¡Se ha guardado los cambios correctamente!'),
          ),
        );
                            ...
                            child: Column(
                              children: [
                                ...
                                DropdownButtonFormField<String>(
                                  value:
                                      _getKeyFromValue(), // Llamamos a la función para obtener la clave seleccionada
                                  ...
                                  items: _numberOfWeeksOptions.keys
                                    ...
                                    return DropdownMenuItem<String>(
                                      value:
                                          option, // El valor aquí debe ser la clave
                                      child: Text(
                                        option,
                                    ...
                                    setState(() {
                                      ...
                                      if (selectedKey != null) {
                                        _selectedNumberOfWeeks =
                                            _numberOfWeeksOptions[
                                                selectedKey]!; // Convertimos la clave en valor numérico
                                      }
                                    });
                                  },
